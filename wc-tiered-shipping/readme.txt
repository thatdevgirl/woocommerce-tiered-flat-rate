...
Add a tiered flat rate shipping option for the WooCommerce plugin.

== Description ==

Admin users can create a tiered flat rate shipping fee based on the total number of items in a user's cart.  There are two tiers in this 
shipping method:
...
specified tier quantity, or a progressive fee, meaning that the tier quantity is used as a multipler to the tiered fee.
